...
<div id="page" class="site" itemscope itemtype="http://schema.org/LocalBusiness">
		...
		<!-- <div class="banner">
			...
			<div class="container" itemprop="description">
				<h1>welcome To Tier List Project</h1>
		...
		<div  id="board"> 
		<div class="row"> 
			<div class="lable">S</div>
		</div>
		<div class="row"> 
			<div class="lable">A</div>
		</div>
		<div class="row"> 
			<div class="lable">B</div>
		</div>
		<div class="row"> 
			<div class="lable">C</div>
		</div>
		<div class="row"> 
			<div class="lable">D</div>
		</div>
		<div class="row"> 
			<div class="lable">E</div>
		</div>
		<div class="row"> 
			<div class="lable">F</div>
		</div>
		</div>
		<h2>Card Bank</h2>
        ...
        <button type="button" class="btn btn-default btn-sm">
           <span class="glyphicon glyphicon-thumbs-up"></span> Report
        </button>
