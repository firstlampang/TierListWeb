...
<div id="createCategory" class="modal">
 		<form name="frm2" class="modal-content animate" action="createCategory" method="post" enctype="multipart/form-data">
   		<div class="imgcontainer">
     			<span onclick="document.getElementById('createCategory').style.display='none'" class="close" title="Close Modal">&times;</span>
   				<!-- <img src="img_avatar2.png" alt="Avatar" class="avatar"> -->
   				<h2>เพิ่ม หมวดหมู่</h2>
 		</div>
 		<div class="container text-center">
  				<label for="uname"><b>ชื่อหมวดหมู่ :</b></label>
   					<input type="text" placeholder="Enter Category Name " name="categoryname" style="width: 50%;" required><br>
   				<label></label><br>
				<label for="psw"><b>รูปหมวดหมู่ : </b></label>
   					<input type="file"  name="catePhoto" accept=".jpg, .jpeg, .png" style="width: 50%; display:inline;" required>	
		 </div>
		 	<div class="container" style="text-align: center;">
				<button type="submit" >save</button>
   				<button type="button"  onclick="document.getElementById('createCategory').style.display='none'" class="cancelbtn">Cancel</button>
 			</div>
		</form>
	</div>
<div id="page" class="site" itemscope itemtype="http://schema.org/LocalBusiness">
							...
							<ul class="menu-list">
								...
								<li class="menu-parent">หมวดหมู่
									<ul class="sub-menu">
										...
										<li><a onclick="document.getElementById('createCategory').style.display='block'">เพิ่มหมวดหมู่</a></li>
									</ul>
								</li>
								<li><a href="">TierList ของคุณ</a></li>
		...
		<c:forEach var="cid" items="${ listcate}">
			<div>
				<h1 id="fimgid">${cid.getCategoryID() }</h1>
				<div><img id="fiximg" src="categorys/${ cid.getCategoryImage() }"></div>
				<div>Name: ${ cid.getCategoryName() }</div>
			</div>	
		</c:forEach>   
			</div>
		</div>
...
<!-- 		<div class="learn-courses">
	...
	<script type="text/javascript">
     // Get the modal
        ...
        var modal2 = document.getElementById('createCategory');
     ...
     var fiximgs =  document.getElementById('fiximg');
     var fimgids =  document.getElementById('fimgid');	
     
     console.log();
     
     fiximgs.style.height = '200px';
		fiximgs.style.width = '200px';
